...
//		JTextField o=sw.getOriginM();
//		 String origin = o.getText();
        String origin="了解DES算法基本工作原理，体会并理解分组密码算法的混淆和扩散概念。了解Sbox工作原理及效果。了解DES的工作模式和填充方式。了解差分攻击的基本原理。\r\n" + 
        		"　DES算法为密码体制中的对称密码体制，又被称为美国数据加密标准。\r\n" + 
        		"　DES是一个分组加密算法，典型的DES以64位为分组对数据加密，加密和解密用的是同一个算法。\r\n" + 
        		"";
        System.out.println("原文：\n"+origin);
        NewDes newDes=new NewDes("密码学",origin);
        //byte[] c=NewDes.deal(origin.getBytes(),1);
       // System.out.println("密文：\n"+new String(c));
        byte[] c=newDes.deal(origin.getBytes(),1);
        //加密结果
        System.out.println("密文：\n"+new String(c));
        byte[]p=newDes.deal(c,0);
        //解密
