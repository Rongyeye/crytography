...
public class jiami_inputKey {
	...
	public static void action() { 
		...
		container.setLayout(null);	//设置容器布局
		 ...
		 JLabel jl = new JLabel("请设置加密密码");
		 JLabel errorLaber = new JLabel("请输入加密密码");
		 errorLaber.setBounds(190, 90, 300, 30);
		 jl.setBounds(190, 190, 300, 30);
		 
		 JButton button = new JButton("提交"), buttonBack = new JButton("返回") , buttonTile = new JButton("加密");
